...
![标签页基本样式](https://gw.alipayobjects.com/zos/rmsportal/dPpWpAhQYzJOWMCeKqhe.png)

引领整个页面的内容，用于主功能切换

##### 卡片样式

![标签页卡片样式](https://gw.alipayobjects.com/zos/rmsportal/aJypXYetynQcJxohHefp.png)

用于页面中局部展示，包裹型容器能很好的和其它内容隔离

##### 胶囊型样式

![标签页胶囊型样式](https://gw.alipayobjects.com/zos/rmsportal/QsgJeCmaQkoRLgGRxUim.png)

用于卡片内的选项切换，经常和其它组件结合使用，让用户快速切换对应内容

##### 竖状样式

![标签页竖状样式](https://gw.alipayobjects.com/zos/rmsportal/WvnEwzlmauGlKByAxZJH.png)
...
![分页器标准样式](https://gw.alipayobjects.com/zos/rmsportal/MlxHpEgkFHhIVaxpaiYJ.png)

当信息条目较多的时候，可以允许用户自定义每页的行数，以提高用户查看和检索信息的效率和灵活性，常与表格、卡片搭配使用

##### 迷你样式

![分页器迷你样式](https://gw.alipayobjects.com/zos/rmsportal/GtIWNdAtogjxXJNuuqTE.png)

一般用于卡片或者浮层

##### 简易样式

![分页器简易样式](https://gw.alipayobjects.com/zos/rmsportal/LCUZrQJyHQXplzEzDrub.png)
